defmodule Backend.Files.File do
  ...
  def changeset(file, attrs) do
    ...
    |> validate_format(:content_type, ~r/^[\w\-\+\.]+\/[\w\-\+\.]+$/, message: "Invalid content type format")
    ...
    |> validate_length(:content_type, max: 100, message: "Content type cannot exceed 100 characters")
