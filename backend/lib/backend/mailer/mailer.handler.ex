defmodule BackendWeb.MailerHandler do
  ...
  def invite(user_email, user_nickname, invitation_url) do
    email_body = """
      <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
      <html xmlns="http://www.w3.org/1999/xhtml" lang="pt-BR">
      <head>
                  ...
                  <td style="padding: 30px 20px; background: #ffffff;">
                      <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                              <td style="text-align: center; padding-bottom: 20px;">
                                  <h1 style="color: #333333; margin:0; font-size: 24px; font-family: Arial, sans-serif;">
                                      Convite para participar de projeto
                                  </h1>
                              </td>
                          </tr>
                          <tr>
                              <td style="text-align: center; padding-bottom: 100px; font-family: Arial, sans-serif; color: #666666; font-size: 16px; line-height: 1.5;">
                                  Olá, #{user_nickname} te convidou para participar de um projeto
                              </td>
                          </tr>
                          <tr>
                              <td style="text-align: center; padding-bottom: 30px;">
                                  <table role="presentation" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
                                      <tr>
                                          <td>
                                              <a href="#{invitation_url}" style="color: #ffffff; text-decoration: none; font-family: Arial, sans-serif; font-size: 16px; display: block; background: #003459; border-radius: 10px; padding: 10px 20px;">
                                                  Aceitar
                                              </a>
                                          </td>
                                      </tr>
