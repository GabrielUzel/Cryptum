defmodule Backend.Projects.ProjectMember do
  ...
  def changeset(project_member, attrs) do
    ...
    |> unique_constraint([:project_id, :user_id], name: :project_members_project_id_user_id_index, message: "This user is already a member of the project")
    |> unique_constraint(:project_id, name: :only_one_admin_per_project, message: "There can only be one admin per project")
  end
end
